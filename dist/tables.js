...
function renderTable(jsonObj) {
    var tableHeader = renderTableHeader(jsonObj);
    var tableBody = renderTableBody(jsonObj);
...
function addNewRow() {
    ...
    elem.innerHTML += renderTableBody(bgtSaleNew);
}

document.body.querySelector('.addLineButton').addEventListener('mousedown', function (event) {
    addNewRow();
});

// добавить сохранение и вычитку изменений из локал стораже